...
@Component({
  selector: 'app-terminated-payments',
  templateUrl: './terminated-payments.component.html',
  styleUrls: ['./terminated-payments.component.scss'], 
  encapsulation: ViewEncapsulation.None
})
export class TerminatedPaymentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._route.queryParams.subscribe(params => {
      ...
      this.installment_id = Number(params.installment_id);
