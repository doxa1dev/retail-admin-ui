...
export class ShippingStatusComponent implements OnInit {
  ...
  columnDefs = [
    { headerName: "Group No.", field: "pieceId", sortable: true, filter: true, width: 100, resizable: false },
    { headerName: "Tracking ID", field: "trackingId", sortable: true, filter: true, width: 140, resizable: false, cellRenderer: (params) => { return this.viewTrackingDetails(params); } },
    { headerName: "Product Name", field: "productName", sortable: true, filter: true, resizable: true , width: 150 },
    { headerName: "Qty", field: "quantity", sortable: true, filter: true, width: 80, resizable: false },
    { headerName: "Status", field: "status", sortable: true, filter: true, resizable: false },
    { headerName: "Date", field: "updatedTime", sortable: true, filter: true, width: 100, resizable: false }
  ];
  ...
  private viewTrackingDetails(params) {
    ...
    if (this.shippers.indexOf(this.shippingAgent) !== -1) {
      isAnchorLink = true;
      const trackingUrl = this.trackingHosts[this.shippingAgent];
      a.href = trackingUrl.replace('<TRACKING_ID>', trackingId);
