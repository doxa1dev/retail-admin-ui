...
@Component({
  selector: 'app-weekly-views',
  templateUrl: './weekly-views.component.html',
  styleUrls: ['./weekly-views.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class WeeklyViewsComponent implements OnChanges {
  ...
  private initSvgAllReaches() {
    d3.selectAll(".singleBarChartWeeklyViews > *").remove();
    this.svg = d3.select(".singleBarChartWeeklyViews");
