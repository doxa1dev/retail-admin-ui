...
@Component({
  selector: 'app-chart-single',
  templateUrl: './chart-single.component.html',
  styleUrls: ['./chart-single.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ChartSingleComponent implements OnChanges {

  @Input() DataNew : NewDatas[]
  ...
  private initSvgAllReaches() {
    d3.selectAll(".singleBarChartToViews > *").remove();
    this.svg = d3.select(".singleBarChartToViews");
